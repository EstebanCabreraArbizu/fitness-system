...
-- Inserción de usuarios (con contraseñas en texto plano)
INSERT INTO Usuario (id, nombres, apellidos, celular, email, contrasenia, status, imagen, fecha_registro, Tipo_usuario_id) VALUES
(1, 'Cliente', 'Ejemplo', '1234567890', 'cliente@ejemplo.com', 'Cliente123!', 1, 'default_user.png', NOW(), 1),
(2, 'Instructor', 'Ejemplo', '0987654321', 'instructor@ejemplo.com', 'Instructor123!', 1, 'default_user.png', NOW(), 2),
(3, 'Admin', 'Sistema', '5555555555', 'admin@sistema.com', 'Admin123!', 1, 'default_user.png', NOW(), 2);
...
(1, 'Rutina inicial', 'Rutina para principiantes con ejercicios básicos', NOW(), 2);
...
-- Crear una dieta
INSERT INTO Dieta (id, tipo_dieta, nombre, descripcion, fecha_inicio, fecha_fin, duracion_dieta, fecha_registro, edad, alergias, enfermedad_cronica, alergia_medicamento, dias_semana, meta_calorias, status, Discipline_id, Usuario_id, Usuario_2_id) VALUES
(1, 'Pérdida de peso', 'Dieta balanceada baja en calorías', 'Dieta equilibrada para bajar de peso de forma gradual', '2023-05-01', '2023-07-31', '3 meses', NOW(), '30-40', 'Ninguna', 'Ninguna', 'Ninguna', 'Lunes-Viernes', 1800, 1, 2, 1, 2);

-- Crear comidas para la dieta
INSERT INTO Comida (id, tipo_comida, dia_dieta, hora, nombre, descripcion, calorias, proteinas, carbohidratos, grasas, recomendacion, image_name, status, Dieta_id) VALUES
(1, 'Desayuno', 'Lunes', '08:00', 'Desayuno proteico', 'Yogurt con frutas y granola', 350, 15, 45, 12, 'Consumir despacio', 'desayuno.jpg', 1, 1),
(2, 'Almuerzo', 'Lunes', '13:00', 'Ensalada de pollo', 'Ensalada verde con pechuga de pollo a la parrilla', 450, 35, 20, 15, 'Añadir limón al gusto', 'ensalada.jpg', 1, 1),
(3, 'Cena', 'Lunes', '20:00', 'Cena ligera', 'Sopa de verduras con pescado al horno', 380, 25, 25, 12, 'Evitar pan', 'cena.jpg', 1, 1);
...
-- Crear productos
INSERT INTO Product (id, title, category, description, marca, purchase_price, price, descuento, previous_price, date, user_id, status, relevant, outstanding, palabras_claves, fecha_inicio, fecha_fin) VALUES
(1, 'Proteína Whey', 1, 'Proteína de suero de leche de alta calidad', 'FitPro', 25.00, 40.00, 0.00, 45.00, '2023-04-15', 2, 1, 1, 1, 'proteina, suplemento, fitness', '2023-04-15', '2023-12-31'),
(2, 'Banda elástica', 2, 'Banda de resistencia para ejercicios', 'GymPlus', 8.00, 15.00, 2.00, 17.00, '2023-04-20', 3, 1, 0, 1, 'banda, resistencia, ejercicio', '2023-04-20', '2023-12-31');
